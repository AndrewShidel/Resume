...
%\par{\fontfamily{phv}\selectfont \centering{\sffamily\Huge Andrew Shidel}
\par{\centering{\sffamily\Huge\fontspec[Variant = 2]{Helvetica Neue}Andrew Shidel}
...
\vspace{0.5 mm}\\
An android app providing a simple, universal means for organizing and communicating between any group or organization.  Build with a team of Drexel students, using Java, Node.js, and the Facebook SDK. \\
